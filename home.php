                    ...
                    <div class="card shadow-lg border-0 rounded-4 overflow-hidden h-100">
                        ...
                        <div class="card-body text-center position-relative">
                            ...
                            <div class="mt-5 pt-3">
                                ...
                                <form method="POST" action="./php/nonMiPiace.php?id=<?php echo $coinquilino['idUtente']?>" class="flex-grow-1">
                                    <button type="submit" class="btn btn-outline-secondary rounded-circle shadow-sm" style="width: 50px; height: 50px;">
                                        <i class="bi bi-x-lg"></i>
                                    </button>
                                </form>

                                <form method="POST" action="./php/miPiace.php?id=<?php echo $coinquilino['idUtente']?>" class="flex-grow-1">
